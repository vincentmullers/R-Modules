...
# It looks like there is clear seasonality in the time-series. Weekly data however tricky to deal with when it comes to time-series modelling. 
...
# In other cases, we transform to smooth data, make a data set "stationary (constant mean and variance over time)" or for example lessen the impact of outliers.
...
# EX11: Let's save what we have as input for the next module. Use write.csv and name the file data_m2.csv.
